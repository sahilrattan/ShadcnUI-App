...
export const UserFormDialog = ({
  ...
  const fields = [
    {
      name: "firstName",
      label: i18n.t({ id: "ui.First Name", message: "First Name" }),
    },
    {
      name: "lastName",
      label: i18n.t({ id: "ui.Last Name", message: "Last Name" }),
    },
    { name: "age", label: i18n.t({ id: "ui.Age", message: "Age" }) },
    { name: "email", label: i18n.t({ id: "ui.Email", message: "Email" }) },
    {
      name: "phone",
      label: i18n.t({ id: "ui.Phone Number", message: "Phone Number" }),
    },
  ] as const;
  const genders = [
    {
      id: "gender.male",
      value: "male",
      label: i18n.t({ id: "ui.Male", message: "Male" }),
    },
    {
      id: "gender.female",
      value: "female",
      label: i18n.t({ id: "ui.Female", message: "Female" }),
    },
    {
      id: "gender.other",
      value: "other",
      label: i18n.t({ id: "ui.Other", message: "Other" }),
    },
  ];
